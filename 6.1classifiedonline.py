...
input_file = 'Processed_Online_With_ParentName.csv'
output_file = 'Processed_Online_With_ParentName_Classified.csv'
...
df['Online_Indicator'] = 1  # Because this is online data
